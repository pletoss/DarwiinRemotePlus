...
-(void) matchIRPoints
{
    ...
    int reverseMatches[4] = {eUndefined, eUndefined, eUndefined, eUndefined};
    
    // all permutations = 4 * 3 * 2 * 1
    ...
    //NSLog(@"lighting up LEDs");

    counter++;
    int led = ( int(counter) ) % 4;
